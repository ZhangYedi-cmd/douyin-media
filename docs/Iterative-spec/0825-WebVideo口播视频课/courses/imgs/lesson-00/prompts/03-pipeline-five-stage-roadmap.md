...
五段生长史，就是学习路线 — Assembly-line panorama

HEADLINE: 五段生长史，就是学习路线
SUBHEAD: 每个模块都从上一个阶段撞到的墙开工

CONVEYOR (left → right)，五个工位：
1. 标题：模块一｜副标题：第 1 到 4 课｜画面：工程师完成第一条口播视频｜清单：网页／配音／质检／录屏
2. 标题：模块二｜副标题：第 5 到 8 课｜画面：机器人给内容卡翻状态并经过人审闸口｜清单：状态机／CLI 记账／发布／人审
3. 标题：模块三｜副标题：第 9 到 10 课｜画面：定时器启动流水线，告警卡飞向工程师｜清单：定时编排／阻塞上报
4. 标题：模块四｜副标题：第 11 到 14 课｜画面：数据回流形成治理回路，质检员审核变更提议｜清单：治理线／复盘反哺／元层自审
5. 标题：模块五｜副标题：第 15 到 17 课｜画面：工程师把 Loop 蓝图带到另一个领域｜清单：教训机制／前端面板／Loop 迁移
ENTRY: 手工做出一条视频
EXIT: 把 Loop 带去自己的领域
FOOTER BAR: 先有产出，再有人催，最后治理没人催会烂的事
LABELS: 第 1 到 4 课；第 5 到 8 课；第 9 到 10 课；第 11 到 14 课；第 15 到 17 课
ASPECT: 1536x1024
