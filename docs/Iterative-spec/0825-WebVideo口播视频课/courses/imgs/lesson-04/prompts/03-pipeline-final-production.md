...
从质检 PASS 到交人审 — Assembly-line panorama

HEADLINE: 从质检 PASS 到交人审
SUBHEAD: 每一步都验最终产物，不拿退出码当验收

CONVEYOR (left → right)，六个工位：
1. 标题：配音质检｜副标题：六项全过｜画面：质检员举绿牌｜清单：VERDICT PASS
2. 标题：无人录屏｜副标题：点击驱动确定性时间线｜画面：AI 机器人操作无头浏览器｜清单：npm run build／npm run record
3. 标题：录后体检｜副标题：查时长、字幕和对位｜画面：工程师对照视频帧和时间尺｜清单：final.mp4／ffprobe／抽帧／±1 秒
4. 标题：竖版封面｜副标题：独立发布物料｜画面：机器人生成 9:16 封面，封面本体只画色块不额外编字｜清单：9:16／非视频帧／锁锚点
5. 标题：终检闸｜副标题：A 到 F 一次过完｜画面：六个浅色检查灯全部变绿｜清单：声画一致／音频自然度／钩子冷启动／事实与合规／封面／音画同步
6. 标题：交人审｜副标题：不可逆操作前停住｜画面：工程师接过最终成片卡，机器人停在闸门外｜清单：交人审
ENTRY: VERDICT PASS
EXIT: 交人审
FOOTER BAR: 验最终产物，不验 exit code
LABELS: VERDICT PASS；npm run build；npm run record；final.mp4；ffprobe；抽帧；±1 秒；9:16；终检闸 A 到 F；交人审
ASPECT: 1536x1024
